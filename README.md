...
*   `/index.html` & `/style.css`: A estrutura principal da minha página de portfólio.
*   `/projeto-login`: Um projeto prático de interface de login para estudo de formulários e alinhamento.
*   `/img`: Assets e imagens utilizadas na interface.

## 🔗 Demonstração | Live Demo
Você pode visualizar este projeto rodando diretamente no navegador através do link abaixo:
> **https://eduardogermano-dev.github.io/portfolio/**

💡 *Sinta-se à vontade para explorar o código e me contatar pelo LinkedIn para batermos um papo!*
